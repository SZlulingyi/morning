...
wea,hum,qua= get_weather()
data = {"weather":{"value":wea},"humidity":{"value":hum},"quality":{"value":qua},"love_days":{"value":get_count()},"birthday_left":{"value":get_birthday()},"words":{"value":get_words(), "color":get_random_color()}}
